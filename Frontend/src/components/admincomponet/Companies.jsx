...
import usegetAllCompaines from "../../hooks/usegetAllCompaines.jsx";
import { useDispatch } from "react-redux";
import { setSearchCompanyByText } from "../../redux/comapnySlice";
...
export const Companies = () => {
  ...
  useEffect(() => { dispatch(setSearchCompanyByText(input)); }, [input, dispatch]);
